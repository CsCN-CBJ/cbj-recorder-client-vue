...
export default {
    ...
    setup() {
        ...
        .then(function(result){ options = result.data; console.log(options); buttonsList.value[0] = options;})
        .catch(function(error){ console.log(error); showToast(error) })
    ...
    methods: {
        ...
        handleTypeChoice(index, value) {
            ...
            .then((result) => { this.buttonsList[index+1] = result.data; console.log(result.data); })
